...
public class SensorDataController {
    ...
    public ResponseEntity<String> insertDataProcessed(@Valid @NonNull @RequestBody SensorDataBundle sensorData) {
        ...
        if (monitorResponse.has("Caution level") && monitorResponse.has("Caution level description")) {
            sensorDataServiceImpl.insertDataProcessed(sensorData, (int) monitorResponse.get("Caution level"), (String) monitorResponse.get("Caution level description"));
