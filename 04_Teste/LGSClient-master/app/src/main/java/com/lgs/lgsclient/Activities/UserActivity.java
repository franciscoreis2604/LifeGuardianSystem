...
public class UserActivity extends AppCompatActivity {
    ...
    private void sendHTTPRequest(){
            final JSONObject payload = SensorReaderGenerator.GenerateRandomSensorReading(session);
        ...
        try {
            ...
            final String threatLevel = (String)response.get("Caution level description");
